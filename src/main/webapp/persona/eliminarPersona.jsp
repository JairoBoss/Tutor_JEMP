	...
	<div class="container-fluid">
		<div class="row">
			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				...
				<form method="POST"
					action="<%=request.getContextPath()%>/Persona/delete?id=<%=persona.getId()%>">
					<div class="row">
						<div class="col-10">
							<div class="mb-3 row">
							...
							<div class="mb-3 row">
								...
								<div class="col-sm-10">
									<input readonly type="number" min="18" max="100"
							...
							<div class="mb-3 row">
								...
								<div class="col-sm-10">
									<input readonly value="${persona.getRfc()}" type="text"
							...
							<div class="mb-3 row">
								...
								<div class="col-sm-10">
									<input readonly value="${persona.getTelefono()}" type="tel"
							...
							<div class="mb-3 row">
								...
								<div class="col-sm-10">
									<input readonly value="${persona.getDomicilio()}" type="text"
