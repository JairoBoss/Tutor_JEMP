	...
	<div class="container-fluid">
		<div class="row">
			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				...
				<form method="POST"
					action="<%=request.getContextPath()%>/Usuario/delete?id=<%=user.getId()%>">
					<div class="row">
						<div class="col-10">
							<div class="mb-3 row">
								...
								<div class="col-sm-10">
									<input required type="text" name="correo" class="form-control"
										readonly value="${user.getCorreo()}" id="correo" />
								</div>
							</div>
							<div class="mb-3 row">
								<label for="descripcion" class="col-sm-2 col-form-label">Contraseña</label>
								<div class="col-sm-10">
									<input required type="password" class="form-control" readonly
							...
							<div class="mb-3 row">
								...
								<div class="col-sm-10">
									<input type="checkbox" id="status" name="status" readonly
