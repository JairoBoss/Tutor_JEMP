...
<head>
<meta charset="UTF-8">
<title>Registrar - Tutor Jairo</title>
			...
			<div
				...
				<div class="col-md-12 col-lg-10 col-xl-6">
					...
					<form method="POST"
						...
						<div class="mb-3 row">
							<label for="apePaterno" class="col-sm-3 col-form-label">Apellido
								paterno:</label>
							<div class="col-sm-9">
						...
						<div class="mb-3 row">
							<label for="apeMaterno" class="col-sm-3 col-form-label">Apellido
								materno:</label>
							<div class="col-sm-9">
						...
						<div class="mb-3 row">
							<label for="correo" class="col-sm-3 col-form-label">Correo
								electrónico:</label>
							<div class="col-sm-9">
						...
						<div class="mb-3 row">
							<label for="nombreEmpresa" class="col-sm-3 col-form-label">Nombre
								empresa:</label>
							<div class="col-sm-9">
